/****************************************************************************
** Meta object code from reading C++ file 'orderdetaildialog.h'
**
...
#include "../../TreeCalculator/orderdetaildialog.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'orderdetaildialog.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 18, 12), // "orderChanged"
QT_MOC_LITERAL(2, 31, 0), // ""
QT_MOC_LITERAL(3, 32, 18), // "btnAddItem_clicked"
QT_MOC_LITERAL(4, 51, 21), // "btnDeleteItem_clicked"
QT_MOC_LITERAL(5, 73, 19), // "btnAllocate_clicked"
QT_MOC_LITERAL(6, 93, 9) // "loadItems"

    },
    "OrderDetailDialog\0orderChanged\0\0"
    "btnAddItem_clicked\0btnDeleteItem_clicked\0"
    "btnAllocate_clicked\0loadItems"
};
...
void OrderDetailDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<OrderDetailDialog *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->orderChanged(); break;
        case 1: _t->btnAddItem_clicked(); break;
        case 2: _t->btnDeleteItem_clicked(); break;
        case 3: _t->btnAllocate_clicked(); break;
        case 4: _t->loadItems(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (OrderDetailDialog::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&OrderDetailDialog::orderChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void OrderDetailDialog::orderChanged()
{
